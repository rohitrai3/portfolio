...
export const FirebaseAuthenticationLogo = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="192"
    height="192"
  ...
  >
    ...
    <g fill="none">
      ...
      <circle
        className="firebase-logo-circle"
        cx="144"
        cy="144"
        r="40"
        fill="#757575"
      />
      <path
        className="firebase-logo-circle-content"
...
export const FirebaseStorageLogo = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="192"
    height="192"
  ...
  >
    ...
    <g fill="none">
      ...
      <path
        className="firebase-logo-circle-content"
        d="M140 128h-12c-2.2 0-3.98 1.8-3.98 4l-.02 24c0 2.2 1.8 4 4 4h32c2.2 0 4-1.8 4-4v-20c0-2.2-1.8-4-4-4h-16zm2.9 23.42l6.432-7.42L158 154h-26l6.5-8z"
        fill="#fff"
        fill-rule="evenodd"
      />
    </g>
...
export const FirebaseRealtimeDatabaseLogo = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="192"
    height="192"
  ...
  >
    ...
    <g fill="none">
      ...
      <path
        className="firebase-logo-circle-content"
        d="M126 150h36v8.004a3.992 3.992 0 0 1-3.99 3.996h-28.02a3.997 3.997 0 0 1-3.99-3.996zm0-20.016c0-2.2 1.786-3.984 3.99-3.984h28.02c2.204 0 3.99 1.8 3.99 3.984v14.032c0 2.2-1.786 3.984-3.99 3.984h-28.02c-2.204 0-3.99-1.8-3.99-3.984zm4 .016h28v6h-28zm0 11.01c0-.56.428-1.01 1.01-1.01h1.98c.56 0 1.01.428 1.01 1.01v1.98a.994.994 0 0 1-1.01 1.01h-1.98a.994.994 0 0 1-1.01-1.01zm0 14c0-.56.428-1.01 1.01-1.01h1.98c.56 0 1.01.428 1.01 1.01v1.98a.994.994 0 0 1-1.01 1.01h-1.98a.994.994 0 0 1-1.01-1.01z"
        fill="#fff"
        fill-rule="evenodd"
      />
    </g>
...
export const ReactLogo = (
  <svg
    ...
    fill="#000000"
    xmlns="http://www.w3.org/2000/svg"
    className="react-logo-circle"
  >
    <circle cx="0" cy="0" r="2"></circle>
    <g
      className="react-logo-ellipse"
      stroke="#000000"
      stroke-width="1"
      fill="none"
    >
...
export const ReduxLogo = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
    <g className="redux-logo" fill="#764ABC">
